...
(defcustom helm-imenu-use-icon t
  "Display an icon from `helm-icons-provider' package when non nil."
  :group 'helm-imenu
  :type 'boolean)

(defcustom helm-imenu-icon-type-alist
  '(("Array"           . (helm-icons-mdicon-icon "crop" :face font-lock-builtin-face))
    ("Arrays"          . (helm-icons-mdicon-icon "crop" :face font-lock-builtin-face))
    ("Boolean"         . (helm-icons-mdicon-icon "crop" :face font-lock-builtin-face))
    ("Booleans"        . (helm-icons-mdicon-icon "crop" :face font-lock-builtin-face))
    ("Class"           . (helm-icons-octicon-icon "package" :face font-lock-type-face))
    ("Classes"         . (helm-icons-octicon-icon "package" :face font-lock-type-face))
    ("Color"           . (helm-icons-mdicon-icon "color_lens" :face font-lock-builtin-face))
    ("Colors"          . (helm-icons-mdicon-icon "color_lens" :face font-lock-builtin-face))
    ("Constant"        . (helm-icons-mdicon-icon "crop" :face font-lock-builtin-face))
    ("Constants"       . (helm-icons-mdicon-icon "crop" :face font-lock-builtin-face))
    ("Constructor"     . (helm-icons-faicon-icon "cube" :face font-lock-function-name-face))
    ("Constructors"    . (helm-icons-faicon-icon "cube" :face font-lock-function-name-face))
    ("Enum Member"     . (helm-icons-octicon-icon "three-bars" :face font-lock-type-face))
    ("Enum Members"    . (helm-icons-octicon-icon "three-bars" :face font-lock-type-face))
    ("Enum"            . (helm-icons-faicon-icon "cog" :face font-lock-type-face))
    ("Enums"           . (helm-icons-faicon-icon "cog" :face font-lock-type-face))
    ("Event"           . (helm-icons-wicon "lightning" :face font-lock-builtin-face))
    ("Events"          . (helm-icons-wicon "lightning" :face font-lock-builtin-face))
    ("Field"           . (helm-icons-octicon-icon "three-bars" :face font-lock-type-face))
    ("Fields"          . (helm-icons-octicon-icon "three-bars" :face font-lock-type-face))
    ("File"            . (helm-icons-faicon-icon "file" :face font-lock-variable-name-face))
    ("Files"           . (helm-icons-faicon-icon "file" :face font-lock-variable-name-face))
    ("Folder"          . (helm-icons-faicon-icon "folder" :face font-lock-variable-name-face))
    ("Folders"         . (helm-icons-faicon-icon "folder" :face font-lock-variable-name-face))
    ("Interface"       . (helm-icons-octicon-icon "package" :face font-lock-builtin-face))
    ("Interfaces"      . (helm-icons-octicon-icon "package" :face font-lock-builtin-face))
    ("Keyword"         . (helm-icons-octicon-icon "key" :face font-lock-builtin-face))
    ("Keywords"        . (helm-icons-octicon-icon "key" :face font-lock-builtin-face))
    ("Method"          . (helm-icons-faicon-icon "cube" :face font-lock-function-name-face))
    ("Methods"         . (helm-icons-faicon-icon "cube" :face font-lock-function-name-face))
    ("Defun"           . (helm-icons-faicon-icon "cube" :face font-lock-function-name-face))
    ("Defuns"          . (helm-icons-faicon-icon "cube" :face font-lock-function-name-face))
    ("Fn"              . (helm-icons-faicon-icon "cube" :face font-lock-function-name-face))
    ("Fns"             . (helm-icons-faicon-icon "cube" :face font-lock-function-name-face))
    ("Function"        . (helm-icons-faicon-icon "cube" :face font-lock-function-name-face))
    ("Functions"       . (helm-icons-faicon-icon "cube" :face font-lock-function-name-face))
    ("Misc"            . (helm-icons-faicon-icon "globe" :face font-lock-function-name-face))
    ("Miscs"           . (helm-icons-faicon-icon "globe" :face font-lock-function-name-face))
    ("Module"          . (helm-icons-faicon-icon "angle-double-right" :face font-lock-builtin-face))
    ("Modules"         . (helm-icons-faicon-icon "angle-double-right" :face font-lock-builtin-face))
    ("Numeric"         . (helm-icons-mdicon-icon "crop" :face font-lock-builtin-face))
    ("Numerics"        . (helm-icons-mdicon-icon "crop" :face font-lock-builtin-face))
    ("Object"          . (helm-icons-faicon-icon "angle-double-right" :face font-lock-builtin-face))
    ("Objects"         . (helm-icons-faicon-icon "angle-double-right" :face font-lock-builtin-face))
    ("Operator"        . (helm-icons-faicon-icon "calculator" :face font-lock-builtin-face))
    ("Operators"       . (helm-icons-faicon-icon "calculator" :face font-lock-builtin-face))
    ("Property"        . (helm-icons-octicon-icon "book" :face font-lock-variable-name-face))
    ("Properties"      . (helm-icons-octicon-icon "book" :face font-lock-variable-name-face))
    ("Reference"       . (helm-icons-octicon-icon "book" :face font-lock-variable-name-face))
    ("References"      . (helm-icons-octicon-icon "book" :face font-lock-variable-name-face))
    ("Snippet"         . (helm-icons-mdicon-icon "border_style" :face font-lock-variable-name-face))
    ("Snippets"        . (helm-icons-mdicon-icon "border_style" :face font-lock-variable-name-face))
    ("String"          . (helm-icons-mdicon-icon "text_fields" :face font-lock-variable-name-face))
    ("Strings"         . (helm-icons-mdicon-icon "text_fields" :face font-lock-variable-name-face))
    ("Struct"          . (helm-icons-faicon-icon "cog" :face font-lock-type-face))
    ("Structs"         . (helm-icons-faicon-icon "cog" :face font-lock-type-face))
    ("Text"            . (helm-icons-mdicon-icon "text_fields" :face font-lock-variable-name-face))
    ("Texts"           . (helm-icons-mdicon-icon "text_fields" :face font-lock-variable-name-face))
    ("Top level"       . (helm-icons-faicon-icon "globe" :face font-lock-function-name-face))
    ("Trait"           . (helm-icons-octicon-icon "package" :face font-lock-builtin-face))
    ("Traits"          . (helm-icons-octicon-icon "package" :face font-lock-builtin-face))
    ("Type"            . (helm-icons-faicon-icon "cog" :face font-lock-type-face))
    ("Types"           . (helm-icons-faicon-icon "cog" :face font-lock-type-face))
    ("Type Parameter"  . (helm-icons-mdicon-icon "code" :face font-lock-type-face))
    ("Type Parameters" . (helm-icons-mdicon-icon "code" :face font-lock-type-face))
    ("Unit"            . (helm-icons-faicon-icon "bar-chart" :face font-lock-builtin-face))
    ("Units"           . (helm-icons-faicon-icon "bar-chart" :face font-lock-builtin-face))
    ("Value"           . (helm-icons-faicon-icon "cog" :face font-lock-type-face))
    ("Values"          . (helm-icons-faicon-icon "cog" :face font-lock-type-face))
    ("Variable"        . (helm-icons-octicon-icon "book" :face font-lock-variable-name-face))
    ("Variables"       . (helm-icons-octicon-icon "book":face font-lock-variable-name-face)))
  "An alist of types associated with a sexp returning an icon.
The sexp should be an `helm-icons-provider' function with its args."
