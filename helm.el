...
(defvar helm-map
  (let ((map (make-sparse-keymap))
    ...
    (substitute-key-definition 'abort-recursive-edit 'helm-keyboard-quit       map parent)
    (substitute-key-definition 'exit-minibuffer      'helm-exit-minibuffer     map parent)
    (substitute-key-definition 'describe-mode        'helm-help                map parent)
    (substitute-key-definition 'kill-line   'helm-delete-minibuffer-contents   map global)
    ...
    ;; Moving
    (substitute-key-definition 'previous-line        'helm-previous-line       map global)
    (substitute-key-definition 'next-line            'helm-next-line           map global)
    (substitute-key-definition 'beginning-of-buffer  'helm-beginning-of-buffer map global)
    (substitute-key-definition 'end-of-buffer        'helm-end-of-buffer       map global)
    (substitute-key-definition 'scroll-down-command  'helm-previous-page       map global)
    (substitute-key-definition 'scroll-up-command    'helm-next-page           map global)
    (substitute-key-definition 'left-char            'helm-previous-source     map global)
    (substitute-key-definition 'right-char           'helm-next-source         map global)
    ...
    ;; Scrolling
    (substitute-key-definition 'scroll-other-window      'helm-scroll-other-window      map global)
    (substitute-key-definition 'scroll-other-window-down 'helm-scroll-other-window-down map global)
    ...
    ;; Debugging
    (define-key map (kbd "C-c C-x C-d")     'helm-debug-output)
    (define-key map (kbd "C-c C-x C-m")     'helm-display-all-visible-marks)
    (define-key map (kbd "C-c C-x C-b")     'helm-send-bug-report-from-helm)
