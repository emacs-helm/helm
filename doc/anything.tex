...
This will happen in the directory where you are when you launch serial rename,
that is ``anything-ff-default-directory''.
The marked files will be renamed in this directory with a new prefix name and starting
...
files.\\
If you mark files in other directories than the current one, these files will be moved to current one.\\
